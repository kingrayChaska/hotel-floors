...
import StandDash3 from "../../../RoomDash/StandDash3";
...
function StandRoom3() {
  return (
    <div>
      ...
      <section className="pt-20 lg:pt-[120px] pb-12 lg:pb-[90px] mx-6">
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full md:w-1/2 lg:w-1/3 px-4">
              ...
              >
                ...
                <h4 className="font-semibold text-xl text-dark mb-3">Room 1</h4>
                <p className="text-body-color">
                  <span className="font-bold text-md">&#8358;30,000</span>
                </p>
